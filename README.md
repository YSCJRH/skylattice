...
- latest stable release: [v0.4.1 Stable](docs/releases/v0-4-1.md)
...
Release notes: [docs/releases/v0.4.1-stable.md](docs/releases/v0.4.1-stable.md)
Latest stable release: [docs/releases/v0-4-1.md](docs/releases/v0-4-1.md)
...
- docs/releases/v0.4.1-stable.md: tracked GitHub release notes source for the latest stable cut
- docs/releases/v0-4-1.md: canonical stable release page for the Pages site
