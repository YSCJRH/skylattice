...
- the public deployment contract now lives in `docs/ops/hosted-alpha-runbook.md`, but deploying it still requires Vercel, Neon, and GitHub OAuth configuration outside the repo
