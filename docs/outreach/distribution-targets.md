...
description: Priority list of external authority surfaces, directories, and communities that fit Skylattice without keyword stuffing or spam.
robots: noindex, follow
---

# Distribution Targets

The goal is not to spray links everywhere. The goal is to earn a small number of truthful mentions that point back to the canonical public Pages surfaces.
...
- `https://yscjrh.github.io/skylattice/zh/releases/v0-2-2/`

## Submission Rule

Only post where Skylattice clearly fits the category. Do not use keyword stuffing, irrelevant comments, or low-context link drops as a discoverability tactic.
